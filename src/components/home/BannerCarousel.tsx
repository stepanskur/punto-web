...
export const BannerCarousel = () => {
  ...
  if (loading) {
    return (
      <section className="relative w-full h-[500px] bg-brand-red animate-pulse flex items-center justify-center">
  ...
  return (
    <section className="relative w-full h-[500px] md:h-[600px] bg-neutral-black">
      <Swiper
